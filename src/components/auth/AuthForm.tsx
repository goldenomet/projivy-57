    ...
    <div className="w-full max-w-md mx-auto px-2 sm:px-0">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 lg:space-y-6">
        {isSignUp && (
          <div className="space-y-1 sm:space-y-2">
            ...
            <Input
              ...
              required={isSignUp}
              className="h-10 sm:h-11 lg:h-12 border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base"
            />
          </div>
        )}
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              required
              className="h-10 sm:h-11 lg:h-12 pl-8 sm:pl-10 border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base"
            />
        ...
        <div className="space-y-1 sm:space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              required
              className="h-10 sm:h-11 lg:h-12 pl-8 sm:pl-10 pr-8 sm:pr-10 border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm sm:text-base"
            />
        ...
        <Button 
          type="button"
          variant="outline"
          className="w-full h-10 sm:h-11 lg:h-12 border-gray-200 hover:bg-gray-50 text-sm sm:text-base rounded-lg"
        >

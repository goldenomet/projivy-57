    ...
    <section className="w-full py-20 animate-slide-in relative">
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        <div className="absolute right-2 bottom-8 sm:right-4 sm:bottom-12 lg:right-8 lg:bottom-16">
          <img alt="Team collaboration illustration with people working together on analytics" className="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 opacity-80 object-cover" src="/lovable-uploads/6a108e84-6201-4318-98bd-8b6dd7131802.png" />
        </div>
